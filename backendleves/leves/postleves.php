...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if(isset($_POST["megnevezes"]) && isset($_POST["kaloria"]) && isset($_POST["feherje"]) && isset($_POST["zsir"]) && isset($_POST["szenhidrat"]) && isset($_POST["hamu"]) && isset($_POST["rost"])) {
        ...
        if ($stmt = $connection->prepare($sql)) {
            $stmt->bind_param("sssssss", $megnevezes, $kaloria, $feherje, $zsir, $szenhidrat, $hamu, $rost);
